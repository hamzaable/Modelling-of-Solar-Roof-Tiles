...
latitude = 50.9375                      #SRT plant latitude [°]
longitude = 6.9603                      #SRT plant longitude [°]
...
num_sdp_series=2 #changed from 12 to 3 
num_sdp_parallel=1 # changed from 36 to 1
...
for i in pv_data.index[0:23]: #changed for testing from [0:8760] to [0...23]
...
column_values = ["Index","Time","Tamb in [°C]","Power in [W]", "Effective Irradiance in [W/m2]"]
...
electrical_data.to_excel(r'Results-PV-Calculation-Single-Diod-Model.xlsx') 
